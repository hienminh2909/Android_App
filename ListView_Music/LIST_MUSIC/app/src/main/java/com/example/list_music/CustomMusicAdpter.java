...
public class CustomMusicAdpter extends BaseAdapter  {
    private Context context;
    private int layout;
    private ArrayList<Music> arrayList;
    private MediaPlayer mediaPlayer;
    private Boolean flag =true;
    public CustomMusicAdpter(Context context, int layout, ArrayList<Music> arrayList)
    {
        ...
        viewholer.img_play.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(mediaPlayer.isPlaying()){
                    ...
                    mediaPlayer.start();
                    viewholer.img_play.setImageResource(R.drawable.nutdung);
                }
            }
        });
